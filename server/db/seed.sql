...
((SELECT class_id FROM classes WHERE class_code = 'P401'), 'Physics Problem Set 1', 'Solve problem set 1 on dynamics.', '2024-09-30 23:59:00'),
((SELECT class_id FROM classes WHERE class_code = 'C101'), 'Chemistry Quiz 1', 'Complete the quiz on atomic structure.', '2024-09-25 23:59:00');
